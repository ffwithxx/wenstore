...
#import "AddDialVC.h"
#import "AddDialCell.h"
#import "DialModel.h"
#import "AFClient.h"
#import "BGControl.h"
#define kCellName @"AddDialCell"
#import "SearchVC.h"
#import "DialDetailVC.h"
#import "orderCountThree.h"
#import "DialAddNewVC.h"
@interface AddDialVC ()<UITableViewDelegate,UITableViewDataSource,fanDataDelegate,asideDelegate,orderCountDelegate,TanDelegate,dialDelegate,zengDataDelegate> {
    NSInteger lpdt036;
...
-(void)jiaoyan {
    ...
    [[AFClient shareInstance] postValidateCart:mastDict detail:detailArr uploadImages:uploadImgArr promoOrders:proOrderArr freeOrders:freeOrderArr withArr:postOneArr withUrl:@"App/Wbp3010/ValidateCart" withjsob001:@"" progressBlock:^(NSProgress *progress) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableView == self.leftTableView){
        ...
        AddDialCell  * _CellTwo = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
        if (!_CellTwo) {
            _CellTwo = [[AddDialCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
        }
...
- (IBAction)buttonClick:(UIButton *)sender {
    if (sender.tag == 201) {
        ...
        if (postArr.count>0) {
            ...
            UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Wendian" bundle:nil];
        DialAddNewVC *addVC = [storyboard instantiateViewControllerWithIdentifier:@"DialAddNewVC"];
