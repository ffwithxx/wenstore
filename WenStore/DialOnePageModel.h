...
@interface DialOnePageModel : BaseModel
...
@property (nonatomic)NSDate *k1mf003;//撥出日期
@property (nonatomic)NSDate *k1mf004;//收貨日期
@property (nonatomic)int k1mf005;//拨出序號
@property (nonatomic)BOOL k1mf006;//收貨/調撥 確認


@property (nonatomic)NSString *k1mf010;//備註
@property (nonatomic)NSString *k1mf011;//撥出門市名稱
