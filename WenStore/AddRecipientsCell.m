...
@implementation AddRecipientsCell{
    RecipientsModel *oneModel;
...
-(void)plusclicks{
    ...
    if (_orderDelegate &&[_orderDelegate respondsToSelector:@selector(getRecipientsOrderCount:withModel:)]) {
        [_orderDelegate getRecipientsOrderCount:[NSDecimalNumber decimalNumberWithString:numStr] withModel:oneModel];
    }
