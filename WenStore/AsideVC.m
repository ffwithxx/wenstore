...
#import "SearchVC.h"
#import "BGControl.h"
#define kCellName @"AsideCell"
@interface AsideVC ()<UITableViewDelegate,UITableViewDataSource,fanDataDelegate>{
    NSInteger lpdt036;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
        ...
        // 通过不同标识创建cell实例
        AsideCell  * _twoCell = [tableView dequeueReusableCellWithIdentifier:kCellName];
        if (!_twoCell) {
            _twoCell = [[AsideCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:kCellName];
        }
        ...
        [_twoCell showModel:model withBillstate:billstate];
        return _twoCell;
