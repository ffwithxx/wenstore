...
-(void)showModel:(TryEatModel *)model {
    ...
    NSInteger lpdt036 = [[NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults] valueForKey:@"3018lpdt036"] ] integerValue];
    ...
    self.countLab.text = [NSString stringWithFormat:@"%@%@",@"试吃数量:",Num];
