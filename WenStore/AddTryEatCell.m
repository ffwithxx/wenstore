...
#import "BGControl.h"
@implementation AddTryEatCell{
    TryEatModel *oneModel;
...
-(void)plusclicks{
    ...
    if (_orderDelegate &&[_orderDelegate respondsToSelector:@selector(getTryEatOrderCount:withModel:)]) {
        [_orderDelegate getTryEatOrderCount:[NSDecimalNumber decimalNumberWithString:numStr] withModel:oneModel];
    }
