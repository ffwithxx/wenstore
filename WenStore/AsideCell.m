...
-(void)showModel:(AsideModel *)model withBillstate:(NSString *)billstate
{
    ...
    NSInteger lpdt036 =  [[NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults] valueForKey:@"3005lpdt036"] ] integerValue];
    NSInteger lpdt042 = [[NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults] valueForKey:@"3005lpdt042"] ] integerValue];
    ...
    if ([billstate isEqualToString:@"0"]) {
