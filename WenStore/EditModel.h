...
@property (nonatomic)NSDecimalNumber  *k1dt101;//叫貨數量
...
@property (nonatomic)NSString  *k1dt502;//说明
@property (nonatomic)NSString  *k1dt501;//说明
@property (nonatomic)NSString  *k1dt503;//说明
@property (nonatomic)NSString  *k1dt800;//说明
