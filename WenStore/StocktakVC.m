...
#define kCellName @"StocktakCell"
#import "SearchVC.h"
@interface StocktakVC ()<UITableViewDelegate,UITableViewDataSource,fanDataDelegate> {
    NSInteger lpdt036;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableView == self.leftTableView){
        ...
        if (!_twoCell) {
            _twoCell = [[StocktakCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:kCellName];
