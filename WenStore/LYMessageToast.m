               ...
               inView:(UIView *)view
{
    ...
    if (frame.size.width > (kScreenSize.width-30)) {
         CGFloat height = [BGControl getSpaceLabelHeight:text withFont:[UIFont systemFontOfSize:14] withWidth:kScreenSize.width - 30];
        frame = CGRectMake(15, 0, kScreenSize.width - 30, height);
    }
