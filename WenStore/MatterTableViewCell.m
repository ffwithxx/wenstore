...
- (void)showModelWithDict:(NSDictionary *)dict {
    self.titleLab.text = [dict valueForKey:@"billName"];
    ...
    self.timeLab.text = [BGControl dateToDateString:[dict valueForKey:@"billDate"]];
    ...
    self.detailLab.text = [dict valueForKey:@"appMsg"];
