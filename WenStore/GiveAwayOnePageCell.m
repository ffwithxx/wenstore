...
#import "BGControl.h"
@implementation GiveAwayOnePageCell{
    GiveAwayOnePageModel *oneModel;
}
...
-(void)showModel:(GiveAwayOnePageModel *)model {
    ...
    NSInteger lpdt043 =[[NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults] valueForKey:@"3019lpdt043"] ] integerValue];
