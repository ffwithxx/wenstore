...
#import "BGControl.h"
@implementation dialOnePageCell{
    DialOnePageModel *oneModel;
}
...
-(void)showModel:(DialOnePageModel *)model {
    ...
    NSInteger lpdt043 =  [[NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults] valueForKey:@"3010lpdt043"] ] integerValue];;
