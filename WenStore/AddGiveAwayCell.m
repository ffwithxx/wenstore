...
#import "BGControl.h"
@implementation AddGiveAwayCell{
    GiveAwayModel *oneModel;
...
-(void)plusclicks{
    ...
    if (_orderDelegate &&[_orderDelegate respondsToSelector:@selector(getGiveAwayOrderCount:withModel:)]) {
        [_orderDelegate getGiveAwayOrderCount:[NSDecimalNumber decimalNumberWithString:numStr] withModel:oneModel];
    }
