...
#import "BGControl.h"
@implementation AddProducedCell{
    ProducedModel *oneModel;
...
-(void)plusclicks{
    ...
    if (_orderDelegate &&[_orderDelegate respondsToSelector:@selector(getproducedOrderCount:withModel:)]) {
        [_orderDelegate getproducedOrderCount:[NSDecimalNumber decimalNumberWithString:numStr] withModel:oneModel];
    }
