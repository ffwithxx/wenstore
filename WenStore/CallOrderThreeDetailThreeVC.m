...
#import "SearchVC.h"
#import "EditModel.h"
#define kCellName @"CallOrderThreeDetailThreeCell"

@interface CallOrderThreeDetailThreeVC ()<UITableViewDataSource,UITableViewDelegate,fanDataDelegate> {
...
@implementation CallOrderThreeDetailThreeVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableView == self.leftTableView){
        ...
        // 通过不同标识创建cell实例
        CallOrderThreeDetailThreeCell  * _twoCell = [tableView dequeueReusableCellWithIdentifier:kCellName];
        if (!_twoCell) {
            _twoCell = [[CallOrderThreeDetailThreeCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:kCellName];
        }
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGFloat height = [BGControl getSpaceLabelHeight:model.k1dt504 withFont:[UIFont systemFontOfSize:14] withWidth:kScreenSize.width-100-52-15];
