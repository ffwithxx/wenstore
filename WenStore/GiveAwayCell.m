...
-(void)showModel:(GiveAwayModel *)model {
    ...
    NSInteger lpdt042 = [[NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults] valueForKey:@"3019lpdt042"] ] integerValue];
    ...
    self.countLab.text = [NSString stringWithFormat:@"%@%@",@"赠送数量:",Num];
