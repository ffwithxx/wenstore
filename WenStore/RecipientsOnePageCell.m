...
#import "BGControl.h"
@implementation RecipientsOnePageCell{
    RecipientsOnePageModel *oneModel;
}
...
-(void)showModel:(RecipientsOnePageModel *)model {
    oneModel = model;
    ...
    NSInteger lpdt043 = [[NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults] valueForKey:@"3013lpdt043"] ] integerValue];;

    self.remarkLab.text = model.k1mf010;
    self.idStrLab.text = model.k1mf100;
    self.sumCountLab.text = [NSString stringWithFormat:@"%@%@%@",@"赠送",model.k1mf303,@"件商品"];
